...
var states = [
        ...
        { name: 'clients', state: { url: '/clients', parent: 'dashboard', templateUrl: 'views/dashboard/clients.html', data: {text: "CLIENTS", visible: true } } },
        { name: 'reviews', state: { url: '/reviews', parent: 'dashboard', templateUrl: 'views/dashboard/reviews.html', data: {text: "REVIEWS", visible: true } } },
        { name: 'addClient', state: { url: '/addClient', parent: 'base', templateUrl: 'views/dashboard/addClient.html', data: {text: "Add Client", visible: false } } },
        { name: 'addReview', state: { url: '/addReview', parent: 'base', templateUrl: 'views/dashboard/addReview.html', data: {text: "Add Review", visible: false } } },
